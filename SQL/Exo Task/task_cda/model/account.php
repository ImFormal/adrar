 ...
 * @param PDO $bdd
 * @param array $account [firstname, lastname, ancien-email, nouveau-mail]
 * @return void
 */
...
function getAccountByEmail(PDO $bdd, string $email): ?array {
    try {
        ...
        // Retourner null si aucun compte n'est trouvé
        return $data ?: null; 
    } catch (Exception $e) {
        echo "Erreur : " . $e->getMessage();
        return null; // Assurer que la fonction retourne bien null en cas d'erreur
    }
}
